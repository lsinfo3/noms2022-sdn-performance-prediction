...
- _Note_: For full mathemetical explanations for some of the more complex metrics, see the paper *"Classification of graph metrics"* by Hernández and Van Mieghem, also cited in our paper in the dataset section, as the implementations in the OOS adhere to their definitions, as stated in the paper *"Simulative Evaluation of KPIs in SDN for Topology Classification and Performance Prediction Models"* by Gray et al., which we extended
